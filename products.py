'''
Transformations applied to the pdoducts(Whisky) data scraped from the website
'''
# %%
...
product_df = pd.read_csv(
    '/home/grivine/Desktop/retail_store/raw_data/whisky_data.csv')

# Changing the Alcohol Price to float
product_df['Alcohol_Price'] = product_df.Alcohol_Price.str.replace(
    ',', '').astype('float')
...
product_df.to_csv('/home/grivine/Desktop/retail_store/transformed_data/whisky_data.csv', index=False)
...
#save to csv
employee_df.to_csv('/home/grivine/Desktop/retail_store/transformed_data/employee_data.csv', index=False)
#%%
...
#save to csv
customer_df.to_csv('/home/grivine/Desktop/retail_store/transformed_data/customer_data.csv', index=False)
#%%

# Generating random days in the range of 1990 to 2022
import pandas as pd
import numpy as np
